...
use Themes\GoTrip\Template\Blocks\MobileQRcode;
...
use Themes\GoTrip\Template\Blocks\FyvHostOnboardingForm;
...
class ModuleProvider extends ServiceProvider
{
    ...
    public static function getTemplateBlocks(){
        return [
            ...
            'mobile_qrcode' => MobileQRcode::class,
            'fyv_host_onboarding_form' => FyvHostOnboardingForm::class
        ];
    }
}
